 ...
 * @LastEditors: henggao
 * @LastEditTime: 2023-10-10 15:32:47
 */
    ...
    children: [
      {
        ...
        name: "预处理",
        meta: { title: "预处理", icon: "bi bi-box", requireAuth: true, roles: ['true', 'false'] },
        component: () => import('@/components/datacenter/CMDataManage.vue')
      },
      {
        path: "/data-overview",
        name: "数据总览",
        meta: { title: "数据总览", icon: "bi bi-box", requireAuth: true, roles: ['true', 'false'] },
