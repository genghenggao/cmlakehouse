 ...
 * @version: v1.0.0
 * @Date: 2023-10-09 21:54:17
 * @LastEditors: henggao
 * @LastEditTime: 2023-10-09 22:39:36
-->
<template>
  <div class="home">
    <div class="home-title">
      <el-card shadow="always">
        ...
        <el-row>
          <el-col :span="1" :offset="1" :xs="4" :sm="4" :md="4" :lg="4" :xl="2">
            <el-avatar :size="60" :src="avatar"></el-avatar>
          </el-col>
          <el-col :span="5" :offset="0" :xs="10" :sm="10" :md="10" :lg="10" :xl="11">
            <div class="greetings">欢迎访问,祝您新的一天工作愉快！</div>
            <div class="weather">今天小雨转阴天,11~20°,天凉,注意加衣</div>
          </el-col>
          <el-col :span="6" :offset="1" :xs="10" :sm="10" :md="10" :lg="11" :xl="1">
            <el-row>
...
export default defineComponent({
  ...
  setup() {
    const state = reactive({
      avatar: require("@/assets/logo.png"), //require需要安装npm i --save-dev @types/node
    });
    return {
      ...toRefs(state),
    };
